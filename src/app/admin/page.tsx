    ...
    <div className="min-h-screen bg-[#0f172a] flex flex-col items-center justify-center px-5">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-10">
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-[#1e293b] border border-[#334155] mb-4 overflow-hidden">
            <Image src="/logo.png" alt="IS Logo" width={80} height={80} className="rounded-full" />
          </div>
